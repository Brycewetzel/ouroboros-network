...
instance ShelleyCompatible era proto => HasBinaryBlockInfo (ShelleyBlock proto era) where
  getBinaryBlockInfo = shelleyBinaryBlockInfo

instance ShelleyCompatible era proto => SerialiseDiskConstraints (ShelleyBlock proto era)

instance ShelleyCompatible era proto => EncodeDisk (ShelleyBlock proto era) (ShelleyBlock proto era) where
  encodeDisk _ = encodeShelleyBlock
instance ShelleyCompatible era proto => DecodeDisk (ShelleyBlock proto era) (Lazy.ByteString -> ShelleyBlock proto era) where
  decodeDisk _ = decodeShelleyBlock

instance ShelleyCompatible era proto => EncodeDisk (ShelleyBlock proto era) (Header (ShelleyBlock proto era)) where
  encodeDisk _ = encodeShelleyHeader
instance ShelleyCompatible era proto => DecodeDisk (ShelleyBlock proto era) (Lazy.ByteString -> Header (ShelleyBlock proto era)) where
  decodeDisk _ = decodeShelleyHeader

instance ShelleyCompatible era proto => EncodeDisk (ShelleyBlock proto era) (LedgerState (ShelleyBlock proto era)) where
  encodeDisk _ = encodeShelleyLedgerState
instance ShelleyCompatible era proto => DecodeDisk (ShelleyBlock proto era) (LedgerState (ShelleyBlock proto era)) where
  decodeDisk _ = decodeShelleyLedgerState

-- | @'ChainDepState' ('BlockProtocol' ('ShelleyBlock' era))@
instance (ShelleyCompatible era proto, EraCrypto era ~ c, SL.PraosCrypto c) => EncodeDisk (ShelleyBlock proto era) (TPraosState c) where
  encodeDisk _ = encode
-- | @'ChainDepState' ('BlockProtocol' ('ShelleyBlock' era))@
instance (ShelleyCompatible era proto, EraCrypto era ~ c, SL.PraosCrypto c) => DecodeDisk (ShelleyBlock proto era) (TPraosState c) where
  decodeDisk _ = decode

instance ShelleyCompatible era proto
...
instance ShelleyCompatible era proto => SerialiseResult (ShelleyBlock proto era) (BlockQuery (ShelleyBlock proto era)) where
  encodeResult _ _ = encodeShelleyResult
  decodeResult _ _ = decodeShelleyResult

instance ShelleyCompatible era proto  => SerialiseNodeToClient (ShelleyBlock proto era) SlotNo where
  encodeNodeToClient _ _ = toCBOR
  decodeNodeToClient _ _ = fromCBOR
...
instance ShelleyCompatible era proto => EncodeDiskDep   (NestedCtxt Header) (ShelleyBlock proto era)
instance ShelleyBasedEra era => DecodeDiskDepIx (NestedCtxt Header) (ShelleyBlock proto era)
instance ShelleyCompatible era proto => DecodeDiskDep   (NestedCtxt Header) (ShelleyBlock proto era)
