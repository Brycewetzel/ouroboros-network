...
instance ShelleyCompatible era proto => ToCBOR (GenTx (ShelleyBlock proto era)) where
...
instance ShelleyCompatible era proto => FromCBOR (GenTx (ShelleyBlock proto era)) where
...
instance ShelleyCompatible (ShelleyEra c) p => TxLimits (ShelleyBlock p (ShelleyEra c)) where
...
instance ShelleyCompatible (AllegraEra c) p => TxLimits (ShelleyBlock p (AllegraEra c)) where
  type TxMeasure (ShelleyBlock p (AllegraEra c)) = ByteSize
  txMeasure        = ByteSize . txInBlockSize . txForgetValidated
  txsBlockCapacity = ByteSize . txsMaxBytes

instance ShelleyCompatible (MaryEra c) p => TxLimits (ShelleyBlock p (MaryEra c)) where
  type TxMeasure (ShelleyBlock p (MaryEra c)) = ByteSize
  txMeasure        = ByteSize . txInBlockSize . txForgetValidated
  txsBlockCapacity = ByteSize . txsMaxBytes

instance ( ShelleyCompatible (AlonzoEra c) p
