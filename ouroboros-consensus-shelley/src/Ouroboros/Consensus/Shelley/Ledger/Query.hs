...
instance ShelleyCompatible era proto => QueryLedger (ShelleyBlock proto era) where
...
instance ShelleyCompatible era proto => ShowQuery (BlockQuery (ShelleyBlock proto era)) where
  showResult = \case
      GetLedgerTip                               -> show
      GetEpochNo                                 -> show
